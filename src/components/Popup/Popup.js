    ...
    <div className={ isOpen ? `popup popup_is-opened` : `popup` }>
      <div className='popup__container'>
        ...
        <nav className='popup__links'>
          <NavLink to={"/"} className='popup__link popup__link_type_home'>Главная</NavLink>
          <NavLink className='popup__link popup__link_type_movies' to={"/movies"}>Фильмы</NavLink>
          <NavLink className='popup__link popup__link_type_saved' to={"/saved-movies"}>Сохранённые фильмы</NavLink>
